...
function vw_education_academy_activation_notice() {
	...
	echo '<h3>'. esc_html__( 'Warm Greetings to you!!', 'vw-education-academy' ) .'</h3>';
...
if ( ! function_exists( 'vw_education_academy_credit' ) ) {
	function vw_education_academy_credit(){
		echo "<a href=".esc_url(VW_EDUCATION_ACADEMY_CREDIT).">".esc_html__('Academic WordPress Theme','vw-education-academy')."</a>";
	}
}
